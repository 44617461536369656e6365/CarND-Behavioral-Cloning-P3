...
lines = []
with open('D:\\Development\\Udacity\\SDC\\windows_sim\\SDC-More\\driving_log.csv') as csvfile:
...
for line in lines:
    ...
    for i in range(3):
        ...
        local_path = "D:\\Development\\Udacity\\SDC\\windows_sim\\SDC-More\\IMG\\" + filename
        #print(local_path)
